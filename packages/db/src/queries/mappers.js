 ...
 */
export function harvestWorldToNewWorld(world) {
  return {
    id: world.id,
    name: world.name,
  };
...
export function harvestItemToNewItem(item) {
  return {
    id: item.id,
    name: item.name,
    namePl: null,
...
export function harvestOutfitToNewOutfit(outfit) {
  return {
    id: outfit.id,
    name: outfit.name,
    namePl: null,
...
export function harvestMountToNewMount(mount) {
  return {
    id: mount.id,
    name: mount.name,
    namePl: null,
