 ...
 */
export declare function auctionItemToNewAuctionItem(
  auctionId: bigint,
  item: ScraperAuctionItemLike,
): NewAuctionItem;
/** Outfit → wiersz `auction_outfits`. */
export declare function auctionOutfitToNewAuctionOutfit(
  auctionId: bigint,
  outfit: ScraperAuctionOutfitLike,
): NewAuctionOutfit;
/** Mount → wiersz `auction_mounts`. */
export declare function auctionMountToNewAuctionMount(
  auctionId: bigint,
  mount: ScraperAuctionMountLike,
): NewAuctionMount;
/** USP → wiersz `auction_usps` (bez `id` — GENERATED ALWAYS). */
export declare function auctionUspToNewAuctionUsp(
  auctionId: bigint,
  usp: ScraperAuctionUspLike,
): NewAuctionUsp;
/** Skill loyalty → wiersz `auction_skill_loyalty`. */
export declare function auctionSkillLoyaltyToNewAuctionSkillLoyalty(
  auctionId: bigint,
 ...
 */
export declare function harvestWorldToNewWorld(world: ScraperHarvestWorldLike): NewWorld;
/** Item (harvest) → wiersz `items` (kategoria `other` — do nadpisania przez T32). */
export declare function harvestItemToNewItem(item: ScraperHarvestItemLike): NewItem;
/** Outfit (harvest) → wiersz `outfits`. */
export declare function harvestOutfitToNewOutfit(outfit: ScraperHarvestReferenceLike): NewOutfit;
/** Mount (harvest) → wiersz `mounts`. */
export declare function harvestMountToNewMount(mount: ScraperHarvestReferenceLike): NewMount;
/**
