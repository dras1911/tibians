...
export const CALCULATOR_CONFIG_SEED: readonly CalculatorConfigSeed[] = [
  // ── Ekonomia (arch §2.1 TibiaPal) ─────────────────────────────
  {
    ...
    value: 13900,
    description:
      'Próg ceny TC w gold. TibiaPal: "Always buy exercise weapons for gold when the price of Tibia Coins is above 13 900 gp". Dokładny break-even TibiaWiki: 13 889 gp/TC.',
  },
  {
    key: 'economy.tc_value_gold',
    value: 10000,
    description:
      'Bazowa wartość 1 TC = 10 000 gp (konwersja gold↔TC w kalkulatorach i wycenie).',
  },
  {
  ...
  },
  {
    ...
    value: 1.1,
    description:
      'Private Training Dummy: +10% skuteczności vs publiczny (TibiaQA).',
  },
  ...
  // ── Loyalty (arch §2.2, TibiaWiki Skills_Calculator) ─────────
  {
    ...
    value: 360,
    description:
      '360 loyalty points = 5% bonusu lojalności (TibiaWiki ground truth).',
  },
  {
  ...
  // ── Stamina (TibiaWiki Stamina) ──────────────────────────────
  {
    ...
    value: 3,
    description:
      '3 min offline = 1 min staminy (normalna strefa 0-39h, premium i free).',
  },
  {
    key: 'stamina.regen_minutes_per_hour_free',
    value: 6,
    description:
      '6 min offline = 1 min staminy (zielona strefa 39-42h, premium-only).',
  },
  {
  ...
  },
  {
    ...
    value: 39,
    description:
      'Zielona strefa (Happy Hours, +50% XP) zaczyna się od 39h staminy.',
  },
  ...
  // ── Blessings (TibiaWiki Blessings) ──────────────────────────
  {
    ...
    value: 2000,
    description:
      'Koszt 1 regularnego błogosławieństwa dla level ≤ 30: 2 000 gp (TibiaWiki).',
  },
  {
    key: 'blessing.cost_per_blessing_level_100',
    value: 16000,
    description:
      'Koszt dla level 100: 200×(100−20) = 16 000 gp (TibiaWiki wzór R(L)).',
  },
  {
    key: 'blessing.cost_per_blessing_level_200',
    value: 26000,
    description:
      'Koszt dla level 200: 20 000 + 75×(200−120) = 26 000 gp (TibiaWiki wzór R(L)).',
  },
  ...
  // ── Imbuement (TibiaWiki Imbuing) ────────────────────────────
  {
    ...
    value: 87500,
    description:
      'Oszczędności z imbuementów: 87 500 gp/h (≈875 TC za 100h przy 10k gp/TC).',
  },
  {
  ...
  // ── Charm / Boss / Quest (heurystyki Bazaar, arch §2.4) ──────
  {
    ...
    value: 9000,
    description:
      'Maksymalna pula punktów charm (heurystyczny tag "Dużo charmów").',
  },
  {
 ...
 */
export async function seedCalculatorConfig(
