...
export const auctionOutfits = pgTable(
  'auction_outfits',
  {
    auctionId: bigint('auction_id', { mode: 'bigint' })
      .notNull()
...
export const auctionMounts = pgTable(
  'auction_mounts',
  {
    auctionId: bigint('auction_id', { mode: 'bigint' })
      .notNull()
...
export const auctionQuests = pgTable(
  'auction_quests',
  {
    auctionId: bigint('auction_id', { mode: 'bigint' })
      .notNull()
...
export const auctionBosses = pgTable(
  'auction_bosses',
  {
    auctionId: bigint('auction_id', { mode: 'bigint' })
      .notNull()
...
export const auctionUsps = pgTable(
  'auction_usps',
  {
...
export const auctionSkillLoyalty = pgTable(
  'auction_skill_loyalty',
  {
    auctionId: bigint('auction_id', { mode: 'bigint' })
      .notNull()
      .references(() => auctions.auctionId, { onDelete: 'cascade' }),
