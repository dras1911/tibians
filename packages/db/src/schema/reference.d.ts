...
export declare const pvpTypeEnum: import("drizzle-orm/pg-core").PgEnum<["Open PvP", "Optional PvP", "Hardcore PvP", "Retro Open PvP", "Retro Hardcore PvP"]>;
export declare const battleyeEnum: import("drizzle-orm/pg-core").PgEnum<["protected", "initially protected", "not protected"]>;
export declare const itemCategoryEnum: import("drizzle-orm/pg-core").PgEnum<["weapon", "armor", "store", "quest", "rune", "consumable", "container", "decoration", "valuable", "other"]>;
export declare const imbuementTierEnum: import("drizzle-orm/pg-core").PgEnum<["basic", "powerful", "epic"]>;
export declare const imbuementCategoryEnum: import("drizzle-orm/pg-core").PgEnum<["damage", "protection", "support", "skill"]>;
export declare const questCategoryEnum: import("drizzle-orm/pg-core").PgEnum<["access", "achievement", "boss", "hunt", "exploration", "other"]>;
export declare const bossDifficultyEnum: import("drizzle-orm/pg-core").PgEnum<["trivial", "harmless", "easy", "medium", "hard", "challenging", "demanding", "insane"]>;
